...
$env:NODE_VIRTUAL_ENV="C:\Users\LENOVO\Desktop\Tercer semestre progra\programacion_3_fernandez\env-node"
...
function global:prompt {
    Write-Host -NoNewline -ForegroundColor Green '(env-node) '
    _OLD_VIRTUAL_PROMPT
}
