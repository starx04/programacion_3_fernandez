...
const MESSAGES: Record<AlertType, string> = {
  success: 'Reserva confirmada para las 8:00 PM.',
  error:   'No hay mesas disponibles en ese horario.',
  warning: 'Tu pedido incluye un ingrediente en promoción por tiempo limitado.',
  info:    'Tu pedido está en preparación en la cocina.',
}
...
export default function LabTwAlert_mp() {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white p-8">
      <h2 className="text-xl font-extrabold mb-1">LAB: Alertas del restaurante</h2>
