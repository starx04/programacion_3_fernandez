...
// │                                                                      │
// │  Bloque useCallback:                                                 │
// │  5  MemoizedList     — useCallback + React.memo: evita re-renders    │
// │  6  SearchWithFetch  — useCallback en deps de useEffect (sin bucle)  │
// │  7  FilterTable      — tres callbacks estables, tabla memoizada      │
// │  8  PaginatedFetch   — useCallback con [page] para paginación        │
// └──────────────────────────────────────────────────────────────────────┘
const PASO = 1
